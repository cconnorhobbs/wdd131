...
function displayAppleCrispRecipe() {
    ...
    if (appleCrisp) {
        const recipeHTML = `
            ...
            <img src="${apple-appleCrisp.jpg}" alt="${appleCrisp.name}" style="max-width: 500px;">
        ...
        recipeContainer.innerHTML = recipeHTML; // Display the recipe in the container
    }
}

// Call the function to display the Apple Crisp recipe
